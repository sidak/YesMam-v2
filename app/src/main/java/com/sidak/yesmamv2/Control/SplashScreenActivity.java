...
import com.sidak.yesmamv2.Database.CoursesDataSource;
import com.sidak.yesmamv2.Database.WorkingDaysDataSource;
import com.sidak.yesmamv2.Model.Course;
import com.sidak.yesmamv2.Model.UnmarkedClass;
import com.sidak.yesmamv2.Model.WorkingDay;
...
public class SplashScreenActivity extends Activity {
    ...
    protected void onResume() {
        ...
        if (!isSet) {
			 ...
			 */
            // it starts the view pager containing fragments for getting data
            runDelayedNextActivity(CircleActivity.class);
        } else {
